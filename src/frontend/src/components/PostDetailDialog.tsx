...
export default function PostDetailDialog({ postId, open, onOpenChange }: PostDetailDialogProps) {
  ...
  const handleSubmitReply = async (e: React.FormEvent) => {
    ...
    const executeCreateReply = async () => {
    ...
    try {
      await checkComplianceAndExecute('createReply', executeCreateReply);
    } catch (error: any) {
      const errorMessage = error?.message || 'Échec de la publication de la réponse. Merci de réessayer.';
